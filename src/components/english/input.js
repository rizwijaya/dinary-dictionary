    ...
    return (
        <div>
            <Container className="mt-5">
                ...
                <h3 className="h12 mt-5">American English Dictionary</h3>
                <Row>
                        ...
                        <Card className="mt-3 sear" border="secondary">
                            ...
                            <Card.Body>
                                {(() => {
                                    if (error) {
                                        return ( //Jika terjadi eror maka tampilkan berikut
                                            <div style={{ color: "red", fontWeight: 500 }}>No entry found matching supplied American English, word and provided filters</div>
                                        )
                                    } else {
                                        return ([ //Jika tidak ada eror
